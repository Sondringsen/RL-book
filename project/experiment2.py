...
def main():
    ...
    print("=" * 60)
    print("Experiment 2: (Inventory, Price) — DP vs RL (regular)")
    print("=" * 60)
    ...
    fig.suptitle("Experiment 2: (Inventory, Price) — DP vs RL (regular)")
    plt.tight_layout()
    ...
    fig2.suptitle("Experiment 2: Policy Heatmaps (DP, regular)")
    plt.tight_layout()
