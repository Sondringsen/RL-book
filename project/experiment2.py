...
def main():
    ...
    axes[0, 2].hist(disc_stats["episode_rewards"], bins=bins, alpha=0.35, label="RL (discrete)", edgecolor="k")
    axes[0, 2].hist(cont_stats["episode_rewards"], bins=bins, alpha=0.35, label="RL (continuous)", edgecolor="k")
    ...
    axes[1, 0].plot(range(1, n_ep + 1), np.cumsum(disc_stats["episode_pnls"]), label="RL (discrete)", lw=1)
    axes[1, 0].plot(range(1, n_ep + 1), np.cumsum(cont_stats["episode_pnls"]), label="RL (continuous)", lw=1)
