...
def main():
    ...
    axes[1, 0].hist(dp_stats["episode_rewards"], bins=bins, alpha=0.4, color="C0", label="DP", edgecolor="k")
    axes[1, 0].hist(disc_stats["episode_rewards"], bins=bins, alpha=0.4, color="C2", label="RL (discrete)", edgecolor="k")
    ...
    axes[1, 1].hist(dp_stats["final_inventories"], bins=inv_bins, alpha=0.4, color="C0", label="DP", edgecolor="k", align="left")
    axes[1, 1].hist(disc_stats["final_inventories"], bins=inv_bins, alpha=0.4, color="C2", label="RL (discrete)", edgecolor="k", align="left")
